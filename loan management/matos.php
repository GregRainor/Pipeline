    ...
    <div style="text-align:right; font-weight: normal;">
		...
		<div class="container" id="main">
			...
			<div class="login-box animated fadeInUp">
				...
				<button style="width:250px;" onclick="window.location.href='./searchmatos.php';">
				search stuff
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./addmatos.php';">
				add stuff
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./delmatos.php';">
				delete stuff
				</button>
				</br>
				<p>
