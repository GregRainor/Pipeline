    ...
    <div style="text-align:right; font-weight: normal;">
		...
		<div class="container" id="main">
			...
			<div class="login-box animated fadeInUp">
				...
				<button style="width:250px;" onclick="window.location.href='./searchuser.php';">
				search user
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./adduser.php';">
				add user
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./deluser.php';">
				delete user
				</button>
				</br>
				<p>
