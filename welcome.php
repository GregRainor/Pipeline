    ...
    <div style="text-align:right; font-weight: normal;">
		...
		<div class="container" id="main">
			...
			<div class="login-box animated fadeInUp">
				...
				<button style="width:250px;" onclick="window.location.href='./pret.php';">
				Loan management
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./matos.php';">
				Stuff management
				</button>
				</br></br></br>
				<button style="width:250px;" onclick="window.location.href='./user.php';">
				User management
				</button>
				</br>
				<p>
